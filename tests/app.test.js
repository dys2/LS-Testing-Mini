...
describe('Cases from app.js', () => { // this is a testing suite made up of suites.
  ...
  describe('Ben', () => {
    ...
    it('the favBand key should be equal to "Beastie Boys"', () => {
      const Ben = cases.Ben;
  ...
  describe('Sean', () => {
    ...
    it('favorite food property should have a value of "Pizza"', () => {
      const Sean = cases.Sean;
  ...
  describe('Ryan', () => {
    ...
    it('favBook property should not equal "Harry Potter"', () => {
      const Ryan = cases.Ryan;
  ...
  describe('Austen', () => {
    ...
    it('favColor property should not be equal to "Gold"', () => {
      const Austen = cases.Austen;
  ...
  describe('Karthik', () => {
    ...
    it('should have a property favActivity equal to "Rock Climbing"', () => {
      const Karthik = cases.Karthik;
  ...
  describe('addNums', () => {
    ...
    // write a test to check if 'addNums' returns the expected value
      ...
      it('should return 3 with arguments 1, 2', () => {
        const addNums = cases.addNums;
  ...
  describe('iterator', () => {
    ...
    it('should call a callback for n times passed to cases.iterator', () => {
      ...
      const n = 4;
      iterator(n, callBack);
      expect(callBack).to.have.callCount(n);
    });
  });
